...
function TestNestedPage() {
  ...
  const navigationLinks = [
    ...
    { path: '/test/nested/deep/456', label: '嵌套参数路由', description: '/test/nested/deep/:id (id=456)' },
    { path: '/test/nested/deep/789', label: '嵌套参数路由', description: '/test/nested/deep/:id (id=789)' },
  ]
    ...
    <>
      <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-6 border border-zinc-200 dark:border-zinc-700">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 mb-6">
          这是 test/nested 路由页面（使用 Outlet 渲染子路由）
        </p>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
            ...
            <div className="flex flex-col gap-2 text-sm">
              <div className="flex items-center gap-2 text-blue-700 dark:text-blue-400">
                ...
                <span className="text-blue-500">→</span>
                <span className="text-zinc-600 dark:text-zinc-400">第一层嵌套 (Level 1)</span>
              </div>
            </div>
          </div>
