...
export default function TestOptionalPage() {
  ...
  const navigationLinks = [
    ...
    { path: '/test/optional', label: '可选参数路由（无参数）', description: '/test/optional/:optional?' },
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-6 border border-zinc-200 dark:border-zinc-700">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 mb-6">
            这是 test/optional/:optional? 路由页面（可选参数）
          </p>
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
              ...
              <div className="flex items-center gap-2 text-sm text-blue-700 dark:text-blue-400">
                ...
                <span className="text-blue-500">→</span>
                <span className="text-zinc-600 dark:text-zinc-400">可选参数路由 (Level 2)</span>
              </div>
            </div>
                    ...
                    <div className="space-y-2">
                      {Object.entries(params).map(([key, value]) => (
                        <div key={ key } className="flex items-center gap-2 text-sm">
                          ...
                          <span className="ml-2 px-2 py-0.5 text-xs bg-amber-100 dark:bg-amber-900/40 text-amber-700 dark:text-amber-400 rounded">
                            可选
                          </span>
                        </div>
                      ))}
            ...
            <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-4 border border-amber-200 dark:border-amber-800">
              <h2 className="text-sm font-semibold text-amber-900 dark:text-amber-300 mb-2 mb-3">
                导航到其他路由
              </h2>
