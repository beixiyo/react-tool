    ...
    steps: [
      {
        ...
        type: 'thinking',
        title: '思考问题',
        content: '我需要分析AI辅助医疗市场，首先我需要考虑以下几个方面：\n1. 市场规模与增长趋势\n2. 主要竞争者分析\n3. 目标用户群体特征\n4. 技术发展趋势\n5. 监管环境与政策影响',
        status: 'completed',
        expanded: true,
      },
      {
      ...
      },
      {
        ...
        type: 'executing',
        title: '执行分析',
        content: '正在分析市场数据...\n\n发现以下关键信息：\n- 全球AI辅助医疗市场预计将从2023年的150亿美元增长到2030年的750亿美元\n- 年复合增长率(CAGR)约为26%\n- 北美占市场份额45%，是领先市场\n- 亚太地区增长最快，占比20%',
        status: 'running',
        expanded: true,
        children: [
          {
...
export const mockAgentTasks: AgentTask[] = [
  {
    ...
    title: 'Research',
    status: 'complete',
    description: 'Market research and competitive analysis completed successfully. Analyzed 50+ competitors and identified key market opportunities.',
    avatar: 'https://images.pexels.com/photos/1036623/pexels-photo-1036623.jpeg?w=100&h=100&fit=crop&crop=face',
    actions: [
      {
        key: 'view-report',
        label: 'View Report',
  ...
  },
  {
    ...
    title: 'Strategist',
    status: 'in-progress',
    description: 'Based on the report and analysis from the analyst, I\'m working on the brand strategy and looking for brand opportunities for you. This includes market positioning, target audience analysis, and competitive differentiation strategies.',
    progress: 75,
  ...
  },
  {
    ...
    status: 'waiting',
    description: 'Waiting to start the creative phase. Will begin working on visual identity, brand guidelines, and creative assets once the strategy is approved.',
  ...
  },
  {
    ...
    status: 'waiting',
    description: 'Content creation and management phase pending. Will develop content strategy, create editorial calendar, and produce initial content pieces.',
  ...
  },
  {
    ...
    status: 'error',
    description: 'Encountered issues during the quality check process. Need to review and fix identified problems before proceeding.',
