    ...
    <div className="mx-auto max-w-6xl">
      <div className="border border-white/20 rounded-2xl bg-white/60 p-8 shadow-xl backdrop-blur-lg dark:border-gray-700/30 dark:bg-gray-800/60">
        <div className="mb-8 text-center">
          <h2 className="from-gray-700 to-gray-900 bg-linear-to-r bg-clip-text text-2xl text-gray-800 text-transparent font-bold dark:from-gray-200 dark:to-gray-400">
            功能说明
          </h2>
          <div className="mx-auto mt-3 h-1 w-24 rounded-full from-blue-500 to-purple-600 bg-linear-to-r" />
        </div>
