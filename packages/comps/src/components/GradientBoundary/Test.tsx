  ...
  return (
    <div className="min-h-screen bg-background p-6 text-text">
      <div className="mx-auto max-w-4xl space-y-8">
        <ThemeToggle />
        <h1 className="mb-6 text-2xl font-bold">GradientBoundary 组件测试</h1>

        <Card className="p-6">
          <h2 className="mb-4 text-xl font-semibold">基础用法</h2>
          <div className="relative h-32 w-full overflow-hidden rounded-lg bg-background3">
        ...
        <Card className="p-6">
          <h2 className="mb-4 text-xl font-semibold">自定义宽度</h2>
          <div className="relative h-32 w-full overflow-hidden rounded-lg bg-background3">
            <div className="flex items-center overflow-x-auto whitespace-nowrap p-4 space-x-4">
              { new Array(20).fill(0).map((_, i) => (
                <div key={ i } className="h-24 w-24 flex shrink-0 items-center justify-center rounded-lg bg-blue-500 text-white font-bold">
        ...
        <Card className="p-6">
          <h2 className="mb-4 text-xl font-semibold">方向设置</h2>
          <div className="space-y-4">
            <div className="flex flex-wrap gap-2">
              { ([
                { name: '左侧', value: 'left' },
            ...
            { (direction === 'top' || direction === 'bottom') && (
              <div className="relative h-64 w-full overflow-hidden rounded-lg bg-background3">
