  ...
  return (
    <div className="min-h-screen bg-background p-6 text-text">
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <h1 className="mb-6 text-2xl font-bold text-text">Radio 组件测试</h1>
        ...
        <Card className="p-6">
          <h2 className="mb-4 text-xl font-semibold text-text">不同尺寸</h2>
        ...
        <Card className="p-6">
          <h2 className="mb-4 text-xl font-semibold text-text">标签位置</h2>
          <div className="flex flex-col gap-4">
            <Radio
              label="标签在右侧 (默认)"
              labelPosition="right"
        ...
        <Card className="p-6">
          <h2 className="mb-4 text-xl font-semibold text-text">错误状态</h2>
          <div className="flex flex-col gap-4">
            <Radio
              label="错误状态"
              error
        ...
        <Card className="p-6">
          <h2 className="mb-4 text-xl font-semibold text-text">单选按钮组 - 垂直布局</h2>
          <RadioGroup
        ...
        <Card className="p-6">
          <h2 className="mb-4 text-xl font-semibold text-text">单选按钮组 - 水平布局</h2>
          <RadioGroup
        ...
        <Card className="p-6">
          <h2 className="mb-4 text-xl font-semibold text-text">单选按钮组 - 错误状态</h2>
          <RadioGroup
            name="options-error"
