...
export default function TaskBannerExample() {
  ...
  return (
    <div className="h-full flex flex-col gap-6 overflow-auto p-4 dark:bg-black">
      <ThemeToggle />

      <div className="flex flex-col gap-2">
        <span className="text-sm text-slate-400 font-semibold">基础：处理中 → 成功 / 失败</span>
      ...
      <div className="flex flex-col gap-2">
        <span className="text-sm text-slate-400 font-semibold">堆叠：最新在上，处理中不计入收拢</span>
        <div className="flex flex-wrap gap-2">
          <Button
            onClick={ () => {
      ...
      <div className="flex flex-col gap-2">
        <span className="text-sm text-slate-400 font-semibold">config：收拢阈值</span>
        <div className="flex flex-wrap gap-2">
