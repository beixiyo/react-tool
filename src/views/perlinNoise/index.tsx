...
export default function NoiseDemo() {
  ...
  return (
    <div className="mx-auto min-h-screen flex gap-4 bg-gray-50 p-4 lg:flex-row">
      ...
      {/* Controls Area */ }
      <div className="flex-grow border border-gray-200 rounded-lg bg-white p-4 shadow">
        ...
        <div className="mt-4 border-t pt-4">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="block w-full border border-gray-300 rounded-md px-3 py-2 shadow-sm focus:border-indigo-500 sm:text-sm focus:ring-indigo-500"
            />
            <button
              onClick={ handleApplySeed }
              className="whitespace-nowrap rounded-md bg-indigo-600 px-4 py-2 text-sm text-white font-medium shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Apply Seed
            </button>
          </div>
