    ...
    <div className="mx-auto max-w-4xl p-4">
      ...
      <div className="mb-8 flex flex-col justify-center gap-4 sm:flex-row">
        <button
          ...
          className="rounded-lg bg-indigo-600 px-4 py-2 text-white shadow transition-colors hover:bg-indigo-700"
        >
          添加随机组件
        </button>
        <button
          onClick={ () => setComponents([]) }
          className="rounded-lg bg-red-600 px-4 py-2 text-white shadow transition-colors hover:bg-red-700"
        >
          移除所有组件
        </button>
      </div>
...
export const UnmountController = memo(({
  ...
  return (
    <div className="relative min-h-[100px] w-full border border-gray-200 rounded-xl bg-gray-50 p-4 shadow-sm">
...
const Box = memo(({ color, text }: { color: string, text: string }) => (
  <div
    ...
    className="border border-gray-200 rounded-lg p-6 shadow transition-all"
  >
