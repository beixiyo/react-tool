  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-10 dark:bg-slate-900">
      <div className="mx-auto max-w-3xl px-4 pt-72 container">
        ...
        {/* 表单状态监视示例 */ }
        <div className="mb-8 border border-slate-200/80 rounded-lg bg-white p-6 shadow-sm dark:border-slate-700/80 dark:bg-slate-800/50">
        ...
        { Object.keys(submittedValues).length > 0 && (
          <div className="border border-slate-200/80 rounded-lg bg-white p-6 shadow-sm dark:border-slate-700/80 dark:bg-slate-800/50">
  ...
  return (
    <div className="fixed top-1 z-50 w-xl rounded-lg bg-slate-100 p-4 center-x dark:bg-slate-700/50">
      ...
      <div className="mt-2">
        ...
        <pre className="max-h-24 overflow-auto rounded bg-slate-200 p-2 text-xs dark:bg-slate-800 dark:text-slate-300">
