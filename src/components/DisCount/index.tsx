    ...
    <div className={ cn(
      ...
      { discountedPrice && (
        <div className={ cn(
          ...
          { discountedPrice && (
            <div className="absolute right-0 rounded from-red-500 to-red-600 bg-gradient-to-r px-1.5 py-0.5 text-xs text-white font-semibold shadow-sm -top-4 dark:from-red-600 dark:to-red-700">
              -
              { discount }
              %
            </div>
